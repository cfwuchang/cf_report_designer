...
class o0o0O ( models . Model ) :
 ...
 def _compute_relation_model ( self ) :
  for OOOoOO0o in self :
   iii11I = self . env [ 'ir.model' ] . _get ( OOOoOO0o . field_id . relation )
   OOOoOO0o . related_field_model_id = iii11I . id if iii11I else None
   if 50 - 50: ii1II11I1ii1I + O0 + iI1Ii11111iIi . II111iiii / o0oOOo0O0Ooo
 def action_retrieve_fields ( self ) :
  if self . field_id and ( self . field_id . ttype == 'one2many' or self . field_id . ttype == 'many2many' or self . field_id . ttype == 'many2one' ) :
   if 17 - 17: iI1Ii11111iIi % iIii1I11I1II1 - iIii1I11I1II1
   if self . env . get ( self . field_id . relation , '_EMPTY' ) == '_EMPTY' :
    raise AccessError ( _ ( "未找到关联字段对应的表（%s），无法获取关联表字段！" % ( self . field_id . relation ) ) )
    if 78 - 78: ii1II11I1ii1I + oO0ooO . o00ooo0 - ii1II11I1ii1I . iI1Ii11111iIi
    if 30 - 30: I1IiiI + OoO0O00 % iI1Ii11111iIi * ii1II11I1ii1I / Oo0Ooo - oO0ooO
   ooo = self . env [ 'ir.model' ] . _get ( self . field_id . relation )
   if 6 - 6: o0oOOo0O0Ooo / oO0ooO / II111iiii
   if 27 - 27: ii11ii1ii * o00ooo0 . iiIIIII1i1iI % oO0o0ooO0 * oO0o0ooO0 . i1IIi
   self . action_remove_fields ( )
   if 72 - 72: ii11ii1ii % I1ii11iIi11i + OoO0O00 / OOooOOo + oO0o0ooO0
   if 10 - 10: iiIIIII1i1iI / o00ooo0 + i11iIiiIii / iI1Ii11111iIi
   for o0OoOo00o0o in ooo . field_id :
    OOOoOO0o = self . env [ 'cf.report.define.field' ] . create ( {
 ...
 "field_id" : o0OoOo00o0o . id ,
    ...
    if 74 - 74: ii11ii1ii + O0 + i1IIi - i1IIi + II111iiii
 def action_remove_fields ( self ) :
  if self . field_id and ( self . field_id . ttype == 'one2many' or self . field_id . ttype == 'many2many' or self . field_id . ttype == 'many2one' ) :
   ...
   if 46 - 46: oO0o0ooO0
   self . env [ "cf.report.define.field" ] . search ( [ ( 'report_id' , '=' , self . report_id . id ) , ( 'model_id' , '=' , ooo . id ) , ( 'related_field_id' , '=' , self . id ) ] ) . unlink ( )
   if 45 - 45: o00ooo0
 def action_view_sub_fields ( self ) :
  self . ensure_one ( )
  if 21 - 21: OOooOOo . iiIIIII1i1iI . ii11ii1ii / Oo0Ooo / iiIIIII1i1iI
  i1iI1 = self . env . ref ( 'cf_report_designer.cf_report_define_field_form' ) . id
 ...
 'flags' : { 'form' : { 'action_buttons' : False } }
  ...
  if 1 - 1: i1IIi . i11iIiiIii % ii11ii1ii
  if 82 - 82: iIii1I11I1II1 + Oo0Ooo . iIii1I11I1II1 % oO0o0ooO0 / iI1Ii11111iIi . iI1Ii11111iIi
  if 14 - 14: o0oOOo0O0Ooo . ii11ii1ii . oO0ooO + OoooooooOO - ii11ii1ii + oO0o0ooO0
  if 9 - 9: iI1Ii11111iIi
  if 59 - 59: I1IiiI * II111iiii . O0
  if 56 - 56: iI1Ii11111iIi - ii1II11I1ii1I % I1IiiI - o0oOOo0O0Ooo
  if 51 - 51: O0 / o00ooo0 * iIii1I11I1II1 + I1ii11iIi11i + o0oOOo0O0Ooo
from xml . dom import minidom
import uuid
if 98 - 98: iIii1I11I1II1 * I1ii11iIi11i * ii11ii1ii + o00ooo0 % i11iIiiIii % O0
i1 = "<h5 style=\"margin-top: 3rem; text-align: center;\">%s</h4>"
if 51 - 51: OoO0O00 - O0 % OOooOOo - II111iiii
if 31 - 31: ii1II11I1ii1I / Oo0Ooo - ii1II11I1ii1I - ii11ii1ii
class I1iiIIIi11 ( models . Model ) :
 if 12 - 12: OoooooooOO % o0oOOo0O0Ooo * oO0ooO % iIii1I11I1II1 / iI1Ii11111iIi
 _inherit = 'ir.actions.report'
 if 27 - 27: i11iIiiIii % II111iiii % oO0ooO . O0 - Oo0Ooo + OoOoOO00
 if 57 - 57: iIii1I11I1II1 / oO0ooO - i1IIi
 if 51 - 51: oO0o0ooO0
 _description = 'Report Action'
 if 25 - 25: OoooooooOO + oO0o0ooO0 * I1ii11iIi11i
 cf_report_define_id = fields . Many2one ( "cf.report.define" , string = "报表定义" , help = "如果是康虎云报表，则保存对应的报表定义。" )
 if 92 - 92: I1IiiI + oO0ooO + O0 / o0oOOo0O0Ooo + iiIIIII1i1iI
 def _make_cfprint_json ( self , values ) :
  if 18 - 18: o00ooo0 * OoOoOO00 . ii1II11I1ii1I / I1ii11iIi11i / i11iIiiIii
  if 21 - 21: OOooOOo / I1ii11iIi11i + iI1Ii11111iIi + OoooooooOO
  def OoOo ( lst ) :
   I1iI11iIiIi1 = set ( )
   if 72 - 72: iiIIIII1i1iI
   if 90 - 90: Oo0Ooo % O0 * iIii1I11I1II1 . ii1II11I1ii1I
   if 8 - 8: o00ooo0 + II111iiii / ii1II11I1ii1I / oO0ooO
   if 74 - 74: O0 / i1IIi
   if 78 - 78: OoooooooOO . OoO0O00 + o00ooo0 - i1IIi
   ii1 = [ ]
   O0iII1 = time . clock ( )
   for II in lst :
    II1i = tuple ( II . items ( ) )
    if II1i not in I1iI11iIiIi1 :
     I1iI11iIiIi1 . add ( II1i )
     ii1 . append ( II )
     if 2 - 2: iIii1I11I1II1 * Oo0Ooo % OOooOOo - II111iiii - ii1II11I1ii1I
   iIi11iiIiI1I = time . clock ( )
   print ( "_remove_duplicated consume: %f" % ( ( iIi11iiIiI1I - O0iII1 ) ) )
   return ii1
   if 3 - 3: i1IIi / II111iiii / i11iIiiIii * i1IIi - II111iiii
  def Ii ( field ) :
   iII1111III1I = "str"
   if 39 - 39: i1IIi / oO0o0ooO0
   if 78 - 78: o00ooo0
   if 53 - 53: o00ooo0 * ii11ii1ii . ii1II11I1ii1I / O0 * o00ooo0
   if 22 - 22: Oo0Ooo % ii1II11I1ii1I * I1ii11iIi11i / ii11ii1ii % i11iIiiIii * oO0ooO
   if 95 - 95: OoooooooOO - oO0o0ooO0 * I1IiiI + OoOoOO00
   if field . ttype in [ "binary" ] :
    iII1111III1I = "blob"
   elif field . ttype in [ "boolean" ] :
    iII1111III1I = "boolean"
  ...
  def o00 ( report_define , model , fields , docs , datas , related_field = False ) :
   oO = { }
   if 92 - 92: oO0o0ooO0 * Oo0Ooo * Oo0Ooo * I1IiiI . iIii1I11I1II1
   if 16 - 16: o00ooo0 % OoooooooOO - ii11ii1ii * iI1Ii11111iIi * I1ii11iIi11i / OoooooooOO
   if 31 - 31: oO0ooO . iiIIIII1i1iI * o00ooo0 + i11iIiiIii * OOooOOo
   if 93 - 93: I1ii11iIi11i / iIii1I11I1II1 * i1IIi % OoooooooOO * O0 * oO0ooO
   if 64 - 64: II111iiii + O0 / iIii1I11I1II1 / Oo0Ooo . o00ooo0 % oO0o0ooO0
   if 50 - 50: iIii1I11I1II1 - oO0o0ooO0 + ii11ii1ii
   if 69 - 69: O0
   if 85 - 85: o00ooo0 / O0
   ...
   for O0OO0O in docs :
    Ii1ii111i1 = { }
    for OOOoOO0o in [ II for II in fields if II . model_id . model == model . model ] :
     try :
      if OOOoOO0o . ttype == 'binary' :
       ...
       if len ( Ii1ii111i1 [ OOOoOO0o . name ] ) > oO . get ( OOOoOO0o . name , OoO ) :
        oO [ OOOoOO0o . name ] = len ( Ii1ii111i1 [ OOOoOO0o . name ] )
       ...
       if OoOo00o0OO and len ( OoOo00o0OO ) > 0 and ii1IIIIiI11 :
        o00 ( report_define , ii1IIIIiI11 , OoOo00o0OO , oOOo000oOoO0 , datas )
       ...
       if len ( Ii1ii111i1 [ OOOoOO0o . name + "_name" ] ) > oO . get ( OOOoOO0o . name + "_name" , OoO ) :
        oO [ OOOoOO0o . name + "_name" ] = len ( Ii1ii111i1 [ OOOoOO0o . name + "_name" ] )
       if len ( Ii1ii111i1 [ OOOoOO0o . name + "_display_name" ] ) > oO . get ( OOOoOO0o . name + "_display_name" , OoO ) :
        oO [ OOOoOO0o . name + "_display_name" ] = len ( Ii1ii111i1 [ OOOoOO0o . name + "_display_name" ] )
       ...
       if len ( OOOoOO0o . related_external_field_ids ) > 0 :
        ...
        if OoOo00o0OO and len ( OoOo00o0OO ) > 0 and ii1IIIIiI11 :
         o00 ( report_define , ii1IIIIiI11 , OoOo00o0OO , oOOo000oOoO0 , datas , OOOoOO0o )
         if 95 - 95: oO0o0ooO0
   ...
   for OOOoOO0o in [ II for II in fields if II . model_id . model == model . model ] :
    iII1111III1I = Ii ( OOOoOO0o )
    if 89 - 89: iiIIIII1i1iI + OoooooooOO + iiIIIII1i1iI * i1IIi + iIii1I11I1II1 % oO0ooO
    oOo0oO = OoO
    if iII1111III1I == "str" :
     oOo0oO = oO . get ( OOOoOO0o . name , OoO )
    if iII1111III1I == "text" :
     oOo0oO = oO . get ( OOOoOO0o . name , OoO )
     iII1111III1I == "str"
     if 5 - 5: ii11ii1ii - ii11ii1ii . Oo0Ooo + OoOoOO00 - ii11ii1ii . OOooOOo
    datas [ oooO0 ] [ "cols" ] . append ( { "type" : iII1111III1I , "size" : oOo0oO , "name" : OOOoOO0o . name , "required" : False , "comment" : OOOoOO0o . field_description } )
    if 31 - 31: II111iiii - iIii1I11I1II1 - iIii1I11I1II1 % oO0ooO
    if 12 - 12: iIii1I11I1II1
    if 20 - 20: o0oOOo0O0Ooo / i1IIi
    if OOOoOO0o . ttype in [ "one2many" , "many2many" ] :
     datas [ oooO0 ] [ "cols" ] . append ( { "type" : "str" , "size" : oO . get ( OOOoOO0o . name , OoO ) , "name" : OOOoOO0o . name + "_ids" , "required" : False , "comment" : OOOoOO0o . field_description } )
     if 71 - 71: OoOoOO00 . i1IIi
    if OOOoOO0o . ttype in [ "many2one" ] :
     datas [ oooO0 ] [ "cols" ] . append ( { "type" : "str" , "size" : oO . get ( OOOoOO0o . name + "_name" , OoO ) , "name" : OOOoOO0o . name + "_name" , "required" : False , "comment" : OOOoOO0o . field_description } )
     datas [ oooO0 ] [ "cols" ] . append ( { "type" : "str" , "size" : oO . get ( OOOoOO0o . name + "_display_name" , OoO ) , "name" : OOOoOO0o . name + "_display_name" , "required" : False , "comment" : OOOoOO0o . field_description } )
     if 94 - 94: ii11ii1ii . iiIIIII1i1iI
    if OOOoOO0o . ttype in [ "selection" ] :
     datas [ oooO0 ] [ "cols" ] . append ( { "type" : "str" , "size" : oO . get ( OOOoOO0o . name + "_name" , OoO ) , "name" : OOOoOO0o . name + "_name" , "required" : False , "comment" : OOOoOO0o . field_description } )
     if 84 - 84: O0 . oO0ooO - II111iiii . o00ooo0 / II111iiii
   datas [ oooO0 ] [ "cols" ] = OoOo ( datas [ oooO0 ] [ "cols" ] )
   if 47 - 47: OoooooooOO
   iIi11iiIiI1I = time . clock ( )
   print ( "_make_data_obj[%s] consume: %f" % ( oooO0 , ( iIi11iiIiI1I - O0iII1 ) ) )
   return datas
 ...
 "Tables" : [ ]
  ...
  if II1i1i1iII1 . use_client_templ and II1i1i1iII1 . client_templ_name :
   ...
   if not II1i1i1iII1 . template_id or not II1i1i1iII1 . template_id . templ_id :
    values . update ( show_message = i1 % ( _ ( "未指定要打印的报表模板，请先指定报表模板。" ) ) )
   oOO = self . env [ 'cf.template' ] . search ( [ ( 'templ_id' , '=' , II1i1i1iII1 . template_id . templ_id ) ] , limit = 1 ) . template
   if not oOO or oOO == "" :
    if not i1ii :
     values . update ( show_message = i1 % ( _ ( "指定的报表模板未定义或模板无内容，请先设计模板并更新到模板记录表。</h3>" ) ) )
    else :
  ...
  OooOOOO = { }
  O0iII1 = time . clock ( )
  o00 ( II1i1i1iII1 , II1i1i1iII1 . model_id , II1i1i1iII1 . field_ids , O0O0Oo00 , OooOOOO )
  iIi11iiIiI1I = time . clock ( )
  print ( "_make_data_obj consume:  %f" % ( iIi11iiIiI1I - O0iII1 ) )
 ...
 "var _delay_close = -1"
  ...
  iIi11iiIiI1I = time . clock ( )
  print ( "Encrypt consume: %f" % ( iIi11iiIiI1I - O0iII1 ) )
 ...
 def render ( self , template , values = None ) :
  ...
  oO0O = i1 % ( _ ( "正在打印，请稍候...<br/><br/>如果打印机未输出报表，请检查康虎云报表是否已启动！<br/><br/><a href=\"cfprint://open\">启动康虎云报表</a>" ) )
 ...
 show_message = oO0O
  ...
  i1II1I = super ( I1iiIIIi11 , self ) . render ( template , values )
  return i1II1I
 ...
 def render_qweb_html ( self , docids , data = None ) :
  ...
  if IIi11I1 :
   ...
   if IIi11I1 :
    ...
    iIi11iiIiI1I = time . clock ( )
    print ( "_make_cfprint_json consume:  %f" % ( iIi11iiIiI1I - O0iII1 ) )
    self . _set_report_data ( data , O0O0ooOOO )
    if 40 - 40: o00ooo0 / OoOoOO00 % i11iIiiIii % I1ii11iIi11i / I1IiiI
  return super ( I1iiIIIi11 , self ) . render_qweb_html ( docids , data )
